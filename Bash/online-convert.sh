...
function displayHelp () {
    ...
    echo ""
    echo "For type \"ebook\":"
    echo "  -f <num>        Sets the target format. See file \"eBook-formats.txt\" for"
    ...
    echo "  -i <input_enc>  Sets the input encoding. See file \"eBook-formats.txt\" for"
    echo "                  the available encodings."
    echo "  -j <embed_font> Sets the embedded font style. See file \"eBook-formats.txt\""
    ...
    echo "                  \"video-formats.txt\" for available direction."
    echo "  -c <codec>      Sets the codec. See file \"video-formats.txt\" for available"
    echo "                  codecs."
    echo "  -s <start>      Sets the start time for the convertation, ie: 00:00:00"
    echo "  -e <end>        Sets the end time for the convertation, ie: 00:00:15"
    echo ""
